				...
				<div class="col-sm-12 login_left">
					<form action="" method="POST">
						<div class="form-group col-sm-6">
							...
							<input type="text" id="edit-name" name="fname" value="<?php echo isset($user_data['firstname']) ? $user_data['firstname'] : ''; ?>" size="60" maxlength="60" class="form-text required">
						</div>
						<div class="form-group col-sm-4">
							<label for="edit-pass">Last Name <span class="form-required" title="This field is required.">*</span></label>
							<input type="text" id="edit-last" name="lname" value="<?php echo isset($user_data['lastname']) ? $user_data['lastname'] : ''; ?>" size="60" maxlength="128" class="form-text required">
						</div>
						<div class="form-group col-sm-2">
							<label for="edit-name">Sex <span class="form-required" title="This field is required.">*</span></label>
							<div class="select-block1">
								<select name="sex">
									<option value="Male <?php echo isset($user_data['sex']) ? $user_data['sex'] : ''; ?>" >Male</option>
									<option value="Female <?php echo isset($user_data['sex']) ? $user_data['sex'] : ''; ?>">Female</option>
						...
						<div class="form-group col-sm-6">
							...
							<input type="text" id="edit-name" name="email" value="<?php echo isset($user_data['email']) ? $user_data['email'] : ''; ?>" size="60" maxlength="60" class="form-text required">
						</div>
						...
						<div class="form-group col-sm-6">
							<div class="age_select">
								...
								<div class="age_grid">
									<div class="col-sm-4 form_box">
										<div class="select-block1">
											<select name="country">
												...
												<option value="UAE">Philippines</option>
									...
									<div class="col-sm-4 form_box2">
									<label for="edit-name">Opt <span class="form-required" title="This field is required."></span></label>
										<div class="select-block1">
											<select name="state">
